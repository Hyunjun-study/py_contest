        ...
        {aiAnalysis && aiAnalysis.ai_enhanced && (
          <div className="ai-panel ai-panel--recommend">
                ...
                <div className="ai-reco-list">
                  {aiAnalysis.analysis.맞춤_추천.map((rec, i) => (
                    <div key={i} className="ai-card">
                      ...
                      <p className="ai-card__line">
                        <strong>추천 이유</strong> {rec.추천_이유}
                      </p>
                      <p className="ai-card__line">
                        <strong>예상 혜택</strong> {rec.예상_혜택}
                      </p>
                    </div>
                  ))}
                </div>
            ...
            {aiAnalysis.analysis?.주의사항 && (
              <div className="ai-section">
                <h5 className="ai-section__title ai-section__title--warn">
                  ⚠️ 주의사항
                </h5>
            ...
            {aiAnalysis.analysis?.다음_단계 && (
              <div className="ai-section">
                <h5 className="ai-section__title ai-section__title--ok">
                  다음 단계
                </h5>
        ...
        {(!aiAnalysis || !aiAnalysis.ai_enhanced) && (
          <div className="ai-debug">
            ...
            <ul className="ai-debug__list">
              ...
              <li>
                AI 활성화:{" "}
                {aiAnalysis && aiAnalysis.ai_enhanced ? "예" : "아니오"}
              </li>
              <li>
                전체 데이터 크기: {JSON.stringify(resultData.policies).length}자
              </li>
            </ul>
            ...
            <div key={`policy-${index}`} className="data-item">
              ...
              <div className="policy-details">
                ...
                {policy.support_content_display && (
                  <p>
                    <strong>지원내용</strong>: {policy.support_content_display}
                  </p>
                )}
                {policy.business_period_display && (
                  <p>
                    <strong>사업기간</strong>: {policy.business_period_display}
                  </p>
                )}
                <p>
                  <strong>신청기간</strong>:{" "}
